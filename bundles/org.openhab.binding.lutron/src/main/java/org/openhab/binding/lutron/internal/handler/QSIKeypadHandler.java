...
/**
 * Handler responsible for communicating with Lutron QS International seeTouch keypads used in
 * Homeworks QS systems
 *
 * @author Bob Adair - Initial contribution
 */
public class QSIKeypadHandler extends BaseKeypadHandler {
    ...
    private static enum Component implements KeypadComponent {
        ...
        CCI1(25, "cci1", ""), // listed in spec but unknown if used in all models
        CCI2(26, "cci2", ""), // listed in spec but unknown if used in all models
    ...
    private final Logger logger = LoggerFactory.getLogger(QSIKeypadHandler.class);
    ...
    public QSIKeypadHandler(Thing thing) {
        super(thing);
    }
