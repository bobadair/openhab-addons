...
/**
 * The {@link CasetaBridgeDiscoveryService} discovers Lutron Caseta Smart Bridge devices on the network using mDNS.
 * Note: We don't get the SN from mDNS so use the MAC address instead.
 *
 * @author Bob Adair - Initial contribution
 */
@Component(immediate = true)
public class CasetaBridgeDiscoveryService implements MDNSDiscoveryParticipant {

    private static final String LUTRON_SERVICE_TYPE = "_lutron._tcp.local."; // Lutron mDNS app.protocol.servicedomain
    //private static final String LUTRON_SERVICE_TYPE = "_amzn-wplay._tcp.local."; // TODO
    private static final String DEFAULT_LABEL = "Caseta Hub";
    
    private final Logger logger = LoggerFactory.getLogger(CasetaBridgeDiscoveryService.class);
    ...
    public @Nullable DiscoveryResult createResult(ServiceInfo service) {
        ...
        properties.put(BRIDGE_TYPE, BRIDGE_TYPE_CASETA);
