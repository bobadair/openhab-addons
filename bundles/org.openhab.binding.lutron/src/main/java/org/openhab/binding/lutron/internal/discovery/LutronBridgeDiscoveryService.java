...
/**
 * The {@link LutronBridgeDiscoveryService} finds RadioRA2 Main Repeaters and HomeWorks QS
...
public class LutronBridgeDiscoveryService extends AbstractDiscoveryService {
    ...
    private final Logger logger = LoggerFactory.getLogger(LutronBridgeDiscoveryService.class);

    private ScheduledFuture<?> scanTask;
    private ScheduledFuture<?> backgroundScan;

    public LutronBridgeDiscoveryService() {
