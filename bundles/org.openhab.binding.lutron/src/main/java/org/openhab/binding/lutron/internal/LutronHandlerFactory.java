...
import org.openhab.binding.lutron.internal.handler.QSIKeypadHandler;
...
public class LutronHandlerFactory extends BaseThingHandlerFactory {
    ...
    public static final Set<ThingTypeUID> DISCOVERABLE_DEVICE_TYPES_UIDS = Collections
            .unmodifiableSet(Stream.of(THING_TYPE_DIMMER, THING_TYPE_SWITCH, THING_TYPE_OCCUPANCYSENSOR,
                    THING_TYPE_KEYPAD, THING_TYPE_TTKEYPAD, THING_TYPE_QSIKEYPAD, THING_TYPE_PICO, THING_TYPE_VIRTUALKEYPAD, THING_TYPE_VCRX,
    ...
    protected @Nullable ThingHandler createHandler(Thing thing) {
        ...
        } else if (thingTypeUID.equals(THING_TYPE_QSIKEYPAD)) {
            return new QSIKeypadHandler(thing);
